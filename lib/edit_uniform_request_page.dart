...
class EditUniformRequestPage extends StatefulWidget {
  ...
  const EditUniformRequestPage({super.key, required this.requestId, required this.requestData});
...
class _EditUniformRequestPageState extends State<EditUniformRequestPage> {
  ...
  Future<void> _saveEdit() async {
    ...
    await FirebaseFirestore.instance.collection('uniform_requests').doc(widget.requestId).update({
      'gender': _gender,
      'course': _course,
      'size': _size,
          ...
          child: ListView(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) => value == null || value.isEmpty ? 'Enter Student Number' : null,
